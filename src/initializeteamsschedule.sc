...
object initializeTeamsSchedule {
/*
  def createScheduleArrays(year: String) = {
    ...
    fileWriter(year + "TeamSchedules", scheduleString)
  }
  //createScheduleArrays("2013")
  //createScheduleArrays("2014")*/
