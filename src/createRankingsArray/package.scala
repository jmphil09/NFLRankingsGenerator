...
package object createRankingsArray {
   ...
   "Jaguars" -> "", "Raiders" -> "", "Browns" -> "")
   	...
   	def updateWeek(map: Map[String, String], week: String): Map[String, String] = {
   		val filename ="C:/Users/James/Desktop/git/NFLRankingsGenerator/data/" + year + week + ".txt"
  	  //val filename ="C:/Users/fligh_000/Desktop/git-workspace/NFLRankingsGenerator/data/" + year + week + ".txt" 
