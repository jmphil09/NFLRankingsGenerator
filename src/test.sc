...
object test {
  ...
  var team1 = new team("team1",2,0, List())       //> team1  : team.team = team.team@5840979b
  var team2 = new team("team2",0,2, List())       //> team2  : team.team = team.team@243cc038
  var team3 = new team("team3",1,1, List())       //> team3  : team.team = team.team@106faf1e
  var team4 = new team("team4",2,0, List())       //> team4  : team.team = team.team@1451e300
  var team5 = new team("team5",1,1, List())       //> team5  : team.team = team.team@c0e1f6c
  var team6 = new team("team6",1,1, List())       //> team6  : team.team = team.team@7330f1a2
